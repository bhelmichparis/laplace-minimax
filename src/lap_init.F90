...
!-----------------------------------------------------------------------------!
  if      (rlen.lt.1.100D00) then
   call lap_assign_error(errbnd,nlap,error_init_1050,ilap_init_1050,nlap_init_1050)
  else if (rlen.lt.1.200D00) then
   call lap_assign_error(errbnd,nlap,error_init_1100,ilap_init_1100,nlap_init_1100)
  else if (rlen.lt.1.300D00) then
   call lap_assign_error(errbnd,nlap,error_init_1200,ilap_init_1200,nlap_init_1200)
  else if (rlen.lt.1.400D00) then
   call lap_assign_error(errbnd,nlap,error_init_1300,ilap_init_1300,nlap_init_1300)
  else if (rlen.lt.1.500D00) then
   call lap_assign_error(errbnd,nlap,error_init_1400,ilap_init_1400,nlap_init_1400)
  else if (rlen.lt.1.600D00) then
   call lap_assign_error(errbnd,nlap,error_init_1500,ilap_init_1500,nlap_init_1500)
  else if (rlen.lt.1.700D00) then
   call lap_assign_error(errbnd,nlap,error_init_1600,ilap_init_1600,nlap_init_1600)
  else if (rlen.lt.1.800D00) then
   call lap_assign_error(errbnd,nlap,error_init_1700,ilap_init_1700,nlap_init_1700)
  else if (rlen.lt.1.900D00) then
   call lap_assign_error(errbnd,nlap,error_init_1800,ilap_init_1800,nlap_init_1800)
  else if (rlen.lt.2.D00) then
   call lap_assign_error(errbnd,nlap,error_init_1900,ilap_init_1900,nlap_init_1900)
  else if (rlen.lt.3.D00) then
...
!-----------------------------------------------------------------------------!
  if      (rlen.lt.1.055D00) then
   ...
   call lap_assign_error(errbnd,nlap,error_init_1055,ilap_init_1055,nlap_init_1055)
  else if (rlen.lt.1.065D00) then
   call lap_assign_error(errbnd,nlap,error_init_1060,ilap_init_1060,nlap_init_1060)
  else if (rlen.lt.1.070D00) then
   call lap_assign_error(errbnd,nlap,error_init_1065,ilap_init_1065,nlap_init_1065)
  else if (rlen.lt.1.075D00) then
   call lap_assign_error(errbnd,nlap,error_init_1070,ilap_init_1070,nlap_init_1070)
  else if (rlen.lt.1.080D00) then
   call lap_assign_error(errbnd,nlap,error_init_1075,ilap_init_1075,nlap_init_1075)
  else if (rlen.lt.1.085D00) then
   call lap_assign_error(errbnd,nlap,error_init_1080,ilap_init_1080,nlap_init_1080)
  else if (rlen.lt.1.090D00) then
   call lap_assign_error(errbnd,nlap,error_init_1085,ilap_init_1085,nlap_init_1085)
  else if (rlen.lt.1.095D00) then
   call lap_assign_error(errbnd,nlap,error_init_1090,ilap_init_1090,nlap_init_1090)
  else if (rlen.lt.1.100D00) then
   call lap_assign_error(errbnd,nlap,error_init_1095,ilap_init_1095,nlap_init_1095)
  else if (rlen.lt.1.105D00) then
   call lap_assign_error(errbnd,nlap,error_init_1100,ilap_init_1100,nlap_init_1100)
  else if (rlen.lt.1.110D00) then
   call lap_assign_error(errbnd,nlap,error_init_1105,ilap_init_1105,nlap_init_1105)
  else if (rlen.lt.1.115D00) then
   call lap_assign_error(errbnd,nlap,error_init_1110,ilap_init_1110,nlap_init_1110)
  else if (rlen.lt.1.120D00) then
   call lap_assign_error(errbnd,nlap,error_init_1115,ilap_init_1115,nlap_init_1115)
  else if (rlen.lt.1.125D00) then
   call lap_assign_error(errbnd,nlap,error_init_1120,ilap_init_1120,nlap_init_1120)
  else if (rlen.lt.1.130D00) then
   call lap_assign_error(errbnd,nlap,error_init_1125,ilap_init_1125,nlap_init_1125)
  else if (rlen.lt.1.135D00) then
   call lap_assign_error(errbnd,nlap,error_init_1130,ilap_init_1130,nlap_init_1130)
  else if (rlen.lt.1.140D00) then
   call lap_assign_error(errbnd,nlap,error_init_1135,ilap_init_1135,nlap_init_1135)
  else if (rlen.lt.1.145D00) then
   call lap_assign_error(errbnd,nlap,error_init_1140,ilap_init_1140,nlap_init_1140)
  else if (rlen.lt.1.150D00) then
   call lap_assign_error(errbnd,nlap,error_init_1145,ilap_init_1145,nlap_init_1145)
  else if (rlen.lt.1.160D00) then
   call lap_assign_error(errbnd,nlap,error_init_1150,ilap_init_1150,nlap_init_1150)
  else if (rlen.lt.1.170D00) then
   call lap_assign_error(errbnd,nlap,error_init_1160,ilap_init_1160,nlap_init_1160)
  else if (rlen.lt.1.180D00) then
   call lap_assign_error(errbnd,nlap,error_init_1170,ilap_init_1170,nlap_init_1170)
  else if (rlen.lt.1.190D00) then
   call lap_assign_error(errbnd,nlap,error_init_1180,ilap_init_1180,nlap_init_1180)
  else if (rlen.lt.1.200D00) then
   call lap_assign_error(errbnd,nlap,error_init_1190,ilap_init_1190,nlap_init_1190)
  else if (rlen.lt.1.210D00) then
   call lap_assign_error(errbnd,nlap,error_init_1200,ilap_init_1200,nlap_init_1200)
  else if (rlen.lt.1.220D00) then
   call lap_assign_error(errbnd,nlap,error_init_1210,ilap_init_1210,nlap_init_1210)
  else if (rlen.lt.1.230D00) then
   call lap_assign_error(errbnd,nlap,error_init_1220,ilap_init_1220,nlap_init_1220)
  else if (rlen.lt.1.240D00) then
   call lap_assign_error(errbnd,nlap,error_init_1230,ilap_init_1230,nlap_init_1230)
  else if (rlen.lt.1.250D00) then
   call lap_assign_error(errbnd,nlap,error_init_1240,ilap_init_1240,nlap_init_1240)
  else if (rlen.lt.1.260D00) then
   call lap_assign_error(errbnd,nlap,error_init_1250,ilap_init_1250,nlap_init_1250)
  else if (rlen.lt.1.270D00) then
   call lap_assign_error(errbnd,nlap,error_init_1260,ilap_init_1260,nlap_init_1260)
  else if (rlen.lt.1.280D00) then
   call lap_assign_error(errbnd,nlap,error_init_1270,ilap_init_1270,nlap_init_1270)
  else if (rlen.lt.1.290D00) then
   call lap_assign_error(errbnd,nlap,error_init_1280,ilap_init_1280,nlap_init_1280)
  else if (rlen.lt.1.300D00) then
   call lap_assign_error(errbnd,nlap,error_init_1290,ilap_init_1290,nlap_init_1290)
  else if (rlen.lt.1.320D00) then
   call lap_assign_error(errbnd,nlap,error_init_1300,ilap_init_1300,nlap_init_1300)
  else if (rlen.lt.1.330D00) then
   call lap_assign_error(errbnd,nlap,error_init_1320,ilap_init_1320,nlap_init_1320)
  else if (rlen.lt.1.350D00) then
   call lap_assign_error(errbnd,nlap,error_init_1330,ilap_init_1330,nlap_init_1330)
  else if (rlen.lt.1.370D00) then
   call lap_assign_error(errbnd,nlap,error_init_1350,ilap_init_1350,nlap_init_1350)
  else if (rlen.lt.1.400D00) then
   call lap_assign_error(errbnd,nlap,error_init_1370,ilap_init_1370,nlap_init_1370)
  else if (rlen.lt.1.420D00) then
   call lap_assign_error(errbnd,nlap,error_init_1400,ilap_init_1400,nlap_init_1400)
  else if (rlen.lt.1.430D00) then
   call lap_assign_error(errbnd,nlap,error_init_1420,ilap_init_1420,nlap_init_1420)
  else if (rlen.lt.1.450D00) then
   call lap_assign_error(errbnd,nlap,error_init_1430,ilap_init_1430,nlap_init_1430)
  else if (rlen.lt.1.470D00) then
   call lap_assign_error(errbnd,nlap,error_init_1450,ilap_init_1450,nlap_init_1450)
  else if (rlen.lt.1.500D00) then
   call lap_assign_error(errbnd,nlap,error_init_1470,ilap_init_1470,nlap_init_1470)
  else if (rlen.lt.1.520D00) then
   call lap_assign_error(errbnd,nlap,error_init_1500,ilap_init_1500,nlap_init_1500)
  else if (rlen.lt.1.550D00) then
   call lap_assign_error(errbnd,nlap,error_init_1520,ilap_init_1520,nlap_init_1520)
  else if (rlen.lt.1.570D00) then
   call lap_assign_error(errbnd,nlap,error_init_1550,ilap_init_1550,nlap_init_1550)
  else if (rlen.lt.1.600D00) then
   call lap_assign_error(errbnd,nlap,error_init_1570,ilap_init_1570,nlap_init_1570)
  else if (rlen.lt.1.620D00) then
   call lap_assign_error(errbnd,nlap,error_init_1600,ilap_init_1600,nlap_init_1600)
  else if (rlen.lt.1.650D00) then
   call lap_assign_error(errbnd,nlap,error_init_1620,ilap_init_1620,nlap_init_1620)
  else if (rlen.lt.1.670D00) then
   call lap_assign_error(errbnd,nlap,error_init_1650,ilap_init_1650,nlap_init_1650)
  else if (rlen.lt.1.700D00) then
   call lap_assign_error(errbnd,nlap,error_init_1670,ilap_init_1670,nlap_init_1670)
  else if (rlen.lt.1.750D00) then
   call lap_assign_error(errbnd,nlap,error_init_1700,ilap_init_1700,nlap_init_1700)
  else if (rlen.lt.1.800D00) then
   call lap_assign_error(errbnd,nlap,error_init_1750,ilap_init_1750,nlap_init_1750)
  else if (rlen.lt.1.850D00) then
   call lap_assign_error(errbnd,nlap,error_init_1800,ilap_init_1800,nlap_init_1800)
  else if (rlen.lt.1.900D00) then
   call lap_assign_error(errbnd,nlap,error_init_1850,ilap_init_1850,nlap_init_1850)
  else if (rlen.lt.1.950D00) then
   call lap_assign_error(errbnd,nlap,error_init_1900,ilap_init_1900,nlap_init_1900)
  else if (rlen.lt.2.D00) then
   call lap_assign_error(errbnd,nlap,error_init_1950,ilap_init_1950,nlap_init_1950)
  else if (rlen.lt.3.D00) then
   call lap_assign_error(errbnd,nlap,error_init_2E00,ilap_init_2E00,nlap_init_2E00)
  else if (rlen.lt.4.D00) then
   call lap_assign_error(errbnd,nlap,error_init_3E00,ilap_init_3E00,nlap_init_3E00)
...
!-----------------------------------------------------------------------------!
  if      (rlen.lt.1.125D00) then
   ...
   call lap_assign_error(errbnd,nlap,error_init_1155,ilap_init_1155,nlap_init_1155)
  else if (rlen.lt.1.165D00) then
   call lap_assign_error(errbnd,nlap,error_init_1160,ilap_init_1160,nlap_init_1160)
  else if (rlen.lt.1.170D00) then
   call lap_assign_error(errbnd,nlap,error_init_1165,ilap_init_1165,nlap_init_1165)
  else if (rlen.lt.1.175D00) then
   call lap_assign_error(errbnd,nlap,error_init_1170,ilap_init_1170,nlap_init_1170)
  else if (rlen.lt.1.180D00) then
   call lap_assign_error(errbnd,nlap,error_init_1175,ilap_init_1175,nlap_init_1175)
  else if (rlen.lt.1.185D00) then
   call lap_assign_error(errbnd,nlap,error_init_1180,ilap_init_1180,nlap_init_1180)
  else if (rlen.lt.1.190D00) then
   call lap_assign_error(errbnd,nlap,error_init_1185,ilap_init_1185,nlap_init_1185)
  else if (rlen.lt.1.195D00) then
   call lap_assign_error(errbnd,nlap,error_init_1190,ilap_init_1190,nlap_init_1190)
  else if (rlen.lt.1.200D00) then
   call lap_assign_error(errbnd,nlap,error_init_1195,ilap_init_1195,nlap_init_1195)
  else if (rlen.lt.1.205D00) then
   call lap_assign_error(errbnd,nlap,error_init_1200,ilap_init_1200,nlap_init_1200)
  else if (rlen.lt.1.210D00) then
   call lap_assign_error(errbnd,nlap,error_init_1205,ilap_init_1205,nlap_init_1205)
  else if (rlen.lt.1.215D00) then
   call lap_assign_error(errbnd,nlap,error_init_1210,ilap_init_1210,nlap_init_1210)
  else if (rlen.lt.1.220D00) then
   call lap_assign_error(errbnd,nlap,error_init_1215,ilap_init_1215,nlap_init_1215)
  else if (rlen.lt.1.225D00) then
   call lap_assign_error(errbnd,nlap,error_init_1220,ilap_init_1220,nlap_init_1220)
  else if (rlen.lt.1.230D00) then
   call lap_assign_error(errbnd,nlap,error_init_1225,ilap_init_1225,nlap_init_1225)
  else if (rlen.lt.1.235D00) then
   call lap_assign_error(errbnd,nlap,error_init_1230,ilap_init_1230,nlap_init_1230)
  else if (rlen.lt.1.240D00) then
   call lap_assign_error(errbnd,nlap,error_init_1235,ilap_init_1235,nlap_init_1235)
  else if (rlen.lt.1.245D00) then
   call lap_assign_error(errbnd,nlap,error_init_1240,ilap_init_1240,nlap_init_1240)
  else if (rlen.lt.1.250D00) then
   call lap_assign_error(errbnd,nlap,error_init_1245,ilap_init_1245,nlap_init_1245)
  else if (rlen.lt.1.260D00) then
   call lap_assign_error(errbnd,nlap,error_init_1250,ilap_init_1250,nlap_init_1250)
  else if (rlen.lt.1.270D00) then
   call lap_assign_error(errbnd,nlap,error_init_1260,ilap_init_1260,nlap_init_1260)
   ...
   call lap_assign_error(errbnd,nlap,error_init_1310,ilap_init_1310,nlap_init_1310)
  else if (rlen.lt.1.330D00) then
   call lap_assign_error(errbnd,nlap,error_init_1320,ilap_init_1320,nlap_init_1320)
  else if (rlen.lt.1.340D00) then
   call lap_assign_error(errbnd,nlap,error_init_1330,ilap_init_1330,nlap_init_1330)
  else if (rlen.lt.1.350D00) then
   call lap_assign_error(errbnd,nlap,error_init_1340,ilap_init_1340,nlap_init_1340)
  else if (rlen.lt.1.360D00) then
   call lap_assign_error(errbnd,nlap,error_init_1350,ilap_init_1350,nlap_init_1350)
  else if (rlen.lt.1.370D00) then
   call lap_assign_error(errbnd,nlap,error_init_1360,ilap_init_1360,nlap_init_1360)
  else if (rlen.lt.1.380D00) then
   call lap_assign_error(errbnd,nlap,error_init_1370,ilap_init_1370,nlap_init_1370)
  else if (rlen.lt.1.390D00) then
   call lap_assign_error(errbnd,nlap,error_init_1380,ilap_init_1380,nlap_init_1380)
  else if (rlen.lt.1.400D00) then
   call lap_assign_error(errbnd,nlap,error_init_1390,ilap_init_1390,nlap_init_1390)
  else if (rlen.lt.1.410D00) then
   call lap_assign_error(errbnd,nlap,error_init_1400,ilap_init_1400,nlap_init_1400)
  else if (rlen.lt.1.420D00) then
   call lap_assign_error(errbnd,nlap,error_init_1410,ilap_init_1410,nlap_init_1410)
  else if (rlen.lt.1.430D00) then
   call lap_assign_error(errbnd,nlap,error_init_1420,ilap_init_1420,nlap_init_1420)
  else if (rlen.lt.1.440D00) then
   call lap_assign_error(errbnd,nlap,error_init_1430,ilap_init_1430,nlap_init_1430)
  else if (rlen.lt.1.450D00) then
   call lap_assign_error(errbnd,nlap,error_init_1440,ilap_init_1440,nlap_init_1440)
  else if (rlen.lt.1.460D00) then
   call lap_assign_error(errbnd,nlap,error_init_1450,ilap_init_1450,nlap_init_1450)
  else if (rlen.lt.1.470D00) then
   call lap_assign_error(errbnd,nlap,error_init_1460,ilap_init_1460,nlap_init_1460)
  else if (rlen.lt.1.480D00) then
   call lap_assign_error(errbnd,nlap,error_init_1470,ilap_init_1470,nlap_init_1470)
  else if (rlen.lt.1.490D00) then
   call lap_assign_error(errbnd,nlap,error_init_1480,ilap_init_1480,nlap_init_1480)
  else if (rlen.lt.1.500D00) then
   call lap_assign_error(errbnd,nlap,error_init_1490,ilap_init_1490,nlap_init_1490)
  else if (rlen.lt.1.510D00) then
   call lap_assign_error(errbnd,nlap,error_init_1500,ilap_init_1500,nlap_init_1500)
  else if (rlen.lt.1.520D00) then
   call lap_assign_error(errbnd,nlap,error_init_1510,ilap_init_1510,nlap_init_1510)
  else if (rlen.lt.1.530D00) then
   call lap_assign_error(errbnd,nlap,error_init_1520,ilap_init_1520,nlap_init_1520)
  else if (rlen.lt.1.540D00) then
   call lap_assign_error(errbnd,nlap,error_init_1530,ilap_init_1530,nlap_init_1530)
  else if (rlen.lt.1.550D00) then
   call lap_assign_error(errbnd,nlap,error_init_1540,ilap_init_1540,nlap_init_1540)
  else if (rlen.lt.1.560D00) then
   call lap_assign_error(errbnd,nlap,error_init_1550,ilap_init_1550,nlap_init_1550)
  else if (rlen.lt.1.570D00) then
   call lap_assign_error(errbnd,nlap,error_init_1560,ilap_init_1560,nlap_init_1560)
  else if (rlen.lt.1.580D00) then
   call lap_assign_error(errbnd,nlap,error_init_1570,ilap_init_1570,nlap_init_1570)
  else if (rlen.lt.1.590D00) then
   call lap_assign_error(errbnd,nlap,error_init_1580,ilap_init_1580,nlap_init_1580)
  else if (rlen.lt.1.600D00) then
   call lap_assign_error(errbnd,nlap,error_init_1590,ilap_init_1590,nlap_init_1590)
  else if (rlen.lt.1.610D00) then
   call lap_assign_error(errbnd,nlap,error_init_1600,ilap_init_1600,nlap_init_1600)
  else if (rlen.lt.1.620D00) then
   call lap_assign_error(errbnd,nlap,error_init_1610,ilap_init_1610,nlap_init_1610)
  else if (rlen.lt.1.630D00) then
   call lap_assign_error(errbnd,nlap,error_init_1620,ilap_init_1620,nlap_init_1620)
  else if (rlen.lt.1.640D00) then
   call lap_assign_error(errbnd,nlap,error_init_1630,ilap_init_1630,nlap_init_1630)
  else if (rlen.lt.1.650D00) then
   call lap_assign_error(errbnd,nlap,error_init_1640,ilap_init_1640,nlap_init_1640)
  else if (rlen.lt.1.660D00) then
   call lap_assign_error(errbnd,nlap,error_init_1650,ilap_init_1650,nlap_init_1650)
  else if (rlen.lt.1.670D00) then
   call lap_assign_error(errbnd,nlap,error_init_1660,ilap_init_1660,nlap_init_1660)
  else if (rlen.lt.1.680D00) then
   call lap_assign_error(errbnd,nlap,error_init_1670,ilap_init_1670,nlap_init_1670)
  else if (rlen.lt.1.690D00) then
   call lap_assign_error(errbnd,nlap,error_init_1680,ilap_init_1680,nlap_init_1680)
  else if (rlen.lt.1.700D00) then
   call lap_assign_error(errbnd,nlap,error_init_1690,ilap_init_1690,nlap_init_1690)
  else if (rlen.lt.1.710D00) then
   call lap_assign_error(errbnd,nlap,error_init_1700,ilap_init_1700,nlap_init_1700)
  else if (rlen.lt.1.720D00) then
   call lap_assign_error(errbnd,nlap,error_init_1710,ilap_init_1710,nlap_init_1710)
  else if (rlen.lt.1.730D00) then
   call lap_assign_error(errbnd,nlap,error_init_1720,ilap_init_1720,nlap_init_1720)
  else if (rlen.lt.1.740D00) then
   call lap_assign_error(errbnd,nlap,error_init_1730,ilap_init_1730,nlap_init_1730)
  else if (rlen.lt.1.750D00) then
   call lap_assign_error(errbnd,nlap,error_init_1740,ilap_init_1740,nlap_init_1740)
  else if (rlen.lt.1.760D00) then
   call lap_assign_error(errbnd,nlap,error_init_1750,ilap_init_1750,nlap_init_1750)
  else if (rlen.lt.1.770D00) then
   call lap_assign_error(errbnd,nlap,error_init_1760,ilap_init_1760,nlap_init_1760)
  else if (rlen.lt.1.780D00) then
   call lap_assign_error(errbnd,nlap,error_init_1770,ilap_init_1770,nlap_init_1770)
  else if (rlen.lt.1.790D00) then
   call lap_assign_error(errbnd,nlap,error_init_1780,ilap_init_1780,nlap_init_1780)
  else if (rlen.lt.1.800D00) then
   call lap_assign_error(errbnd,nlap,error_init_1790,ilap_init_1790,nlap_init_1790)
  else if (rlen.lt.1.810D00) then
   call lap_assign_error(errbnd,nlap,error_init_1800,ilap_init_1800,nlap_init_1800)
  else if (rlen.lt.1.820D00) then
   call lap_assign_error(errbnd,nlap,error_init_1810,ilap_init_1810,nlap_init_1810)
  else if (rlen.lt.1.830D00) then
   call lap_assign_error(errbnd,nlap,error_init_1820,ilap_init_1820,nlap_init_1820)
  else if (rlen.lt.1.840D00) then
   call lap_assign_error(errbnd,nlap,error_init_1830,ilap_init_1830,nlap_init_1830)
  else if (rlen.lt.1.850D00) then
   call lap_assign_error(errbnd,nlap,error_init_1840,ilap_init_1840,nlap_init_1840)
  else if (rlen.lt.1.860D00) then
   call lap_assign_error(errbnd,nlap,error_init_1850,ilap_init_1850,nlap_init_1850)
  else if (rlen.lt.1.870D00) then
   call lap_assign_error(errbnd,nlap,error_init_1860,ilap_init_1860,nlap_init_1860)
  else if (rlen.lt.1.880D00) then
   call lap_assign_error(errbnd,nlap,error_init_1870,ilap_init_1870,nlap_init_1870)
  else if (rlen.lt.1.890D00) then
   call lap_assign_error(errbnd,nlap,error_init_1880,ilap_init_1880,nlap_init_1880)
  else if (rlen.lt.1.900D00) then
   call lap_assign_error(errbnd,nlap,error_init_1890,ilap_init_1890,nlap_init_1890)
  else if (rlen.lt.1.910D00) then
   call lap_assign_error(errbnd,nlap,error_init_1900,ilap_init_1900,nlap_init_1900)
  else if (rlen.lt.1.920D00) then
   call lap_assign_error(errbnd,nlap,error_init_1910,ilap_init_1910,nlap_init_1910)
  else if (rlen.lt.1.930D00) then
   call lap_assign_error(errbnd,nlap,error_init_1920,ilap_init_1920,nlap_init_1920)
  else if (rlen.lt.1.940D00) then
   call lap_assign_error(errbnd,nlap,error_init_1930,ilap_init_1930,nlap_init_1930)
  else if (rlen.lt.1.950D00) then
   call lap_assign_error(errbnd,nlap,error_init_1940,ilap_init_1940,nlap_init_1940)
  else if (rlen.lt.1.960D00) then
   call lap_assign_error(errbnd,nlap,error_init_1950,ilap_init_1950,nlap_init_1950)
  else if (rlen.lt.1.970D00) then
   call lap_assign_error(errbnd,nlap,error_init_1960,ilap_init_1960,nlap_init_1960)
  else if (rlen.lt.1.980D00) then
   call lap_assign_error(errbnd,nlap,error_init_1970,ilap_init_1970,nlap_init_1970)
  else if (rlen.lt.2.D00) then
   call lap_assign_error(errbnd,nlap,error_init_1980,ilap_init_1980,nlap_init_1980)
  else if (rlen.lt.3.D00) then
   call lap_assign_error(errbnd,nlap,error_init_2E00,ilap_init_2E00,nlap_init_2E00)
  else if (rlen.lt.4.D00) then
   call lap_assign_error(errbnd,nlap,error_init_3E00,ilap_init_3E00,nlap_init_3E00)
